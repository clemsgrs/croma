        ...
        rows.append(
            {
                ...
                "mari": 0.85 + 0.002 * idx,
                "ccrr": 1.18 + 0.01 * idx,
                "ccrr_q_alpha": 0.82 - 0.01 * idx,
                "ccrr_ltm_alpha": 0.71 - 0.005 * idx,
            }
        )
...
def _per_sample_row(
    *,
    ...
    return {
        ...
        "ccrr_m1": float(ccrr_m1),
    }


def _binary_camelyon_like_per_sample_df() -> pd.DataFrame:
    rows = [
        _per_sample_row(model="M_fragile", sample_id="a_t_r_1", label="tumor", medical_center="RUMC", ccrr_m1=0.40),
        _per_sample_row(model="M_fragile", sample_id="b_t_r_2", label="tumor", medical_center="RUMC", ccrr_m1=0.50),
        _per_sample_row(model="M_fragile", sample_id="c_t_u_3", label="tumor", medical_center="UMCU", ccrr_m1=0.90),
        _per_sample_row(model="M_fragile", sample_id="d_t_u_4", label="tumor", medical_center="UMCU", ccrr_m1=1.60),
        _per_sample_row(model="M_fragile", sample_id="z_n_r_5", label="normal", medical_center="RUMC", ccrr_m1=0.50),
        _per_sample_row(model="M_fragile", sample_id="f_n_r_6", label="normal", medical_center="RUMC", ccrr_m1=1.20),
        _per_sample_row(model="M_fragile", sample_id="g_n_u_7", label="normal", medical_center="UMCU", ccrr_m1=1.30),
        _per_sample_row(model="M_fragile", sample_id="h_n_u_8", label="normal", medical_center="UMCU", ccrr_m1=1.40),
        _per_sample_row(model="M_stable", sample_id="a_t_r_1", label="tumor", medical_center="RUMC", ccrr_m1=0.70),
        _per_sample_row(model="M_stable", sample_id="b_t_r_2", label="tumor", medical_center="RUMC", ccrr_m1=1.05),
        _per_sample_row(model="M_stable", sample_id="c_t_u_3", label="tumor", medical_center="UMCU", ccrr_m1=1.10),
        _per_sample_row(model="M_stable", sample_id="d_t_u_4", label="tumor", medical_center="UMCU", ccrr_m1=1.20),
        _per_sample_row(model="M_stable", sample_id="z_n_r_5", label="normal", medical_center="RUMC", ccrr_m1=0.75),
        _per_sample_row(model="M_stable", sample_id="f_n_r_6", label="normal", medical_center="RUMC", ccrr_m1=1.00),
        _per_sample_row(model="M_stable", sample_id="g_n_u_7", label="normal", medical_center="UMCU", ccrr_m1=1.15),
        _per_sample_row(model="M_stable", sample_id="h_n_u_8", label="normal", medical_center="UMCU", ccrr_m1=1.30),
    ]
    return pd.DataFrame(rows)
...
def _borderline_fragility_per_sample_df() -> pd.DataFrame:
    rows = [
        _per_sample_row(model="M_borderline", sample_id="a1", label="tumor", medical_center="RUMC", ccrr_m1=0.40),
        _per_sample_row(model="M_borderline", sample_id="a2", label="tumor", medical_center="RUMC", ccrr_m1=0.50),
        _per_sample_row(model="M_borderline", sample_id="a3", label="tumor", medical_center="RUMC", ccrr_m1=1.10),
        _per_sample_row(model="M_borderline", sample_id="a4", label="tumor", medical_center="RUMC", ccrr_m1=1.20),
        _per_sample_row(model="M_borderline", sample_id="b1", label="normal", medical_center="RUMC", ccrr_m1=0.60),
        _per_sample_row(model="M_borderline", sample_id="b2", label="normal", medical_center="RUMC", ccrr_m1=1.30),
        _per_sample_row(model="M_borderline", sample_id="c1", label="tumor", medical_center="UMCU", ccrr_m1=1.40),
        _per_sample_row(model="M_borderline", sample_id="c2", label="tumor", medical_center="UMCU", ccrr_m1=1.50),
        _per_sample_row(model="M_borderline", sample_id="d1", label="normal", medical_center="UMCU", ccrr_m1=1.60),
        _per_sample_row(model="M_borderline", sample_id="d2", label="normal", medical_center="UMCU", ccrr_m1=1.70),
    ]
    return pd.DataFrame(rows)
...
def _sharp_tail_only_per_sample_df() -> pd.DataFrame:
    rows = [
        _per_sample_row(model="M_sharp", sample_id="a1", label="tumor", medical_center="RUMC", ccrr_m1=0.30),
        _per_sample_row(model="M_sharp", sample_id="a2", label="tumor", medical_center="RUMC", ccrr_m1=0.35),
        _per_sample_row(model="M_sharp", sample_id="a3", label="tumor", medical_center="RUMC", ccrr_m1=1.60),
        _per_sample_row(model="M_sharp", sample_id="a4", label="tumor", medical_center="RUMC", ccrr_m1=1.70),
        _per_sample_row(model="M_sharp", sample_id="b1", label="normal", medical_center="RUMC", ccrr_m1=0.40),
        _per_sample_row(model="M_sharp", sample_id="b2", label="normal", medical_center="RUMC", ccrr_m1=0.80),
        _per_sample_row(model="M_sharp", sample_id="b3", label="normal", medical_center="RUMC", ccrr_m1=0.85),
        _per_sample_row(model="M_sharp", sample_id="b4", label="normal", medical_center="RUMC", ccrr_m1=0.90),
        _per_sample_row(model="M_sharp", sample_id="c1", label="tumor", medical_center="UMCU", ccrr_m1=0.95),
        _per_sample_row(model="M_sharp", sample_id="c2", label="tumor", medical_center="UMCU", ccrr_m1=1.05),
        _per_sample_row(model="M_sharp", sample_id="d1", label="normal", medical_center="UMCU", ccrr_m1=1.10),
        _per_sample_row(model="M_sharp", sample_id="d2", label="normal", medical_center="UMCU", ccrr_m1=1.20),
    ]
    return pd.DataFrame(rows)
...
def test_build_ccrr_subgroup_analysis_highlights_tumor_fragility() -> None:
    ...
    assert float(tumor_row["mean_ccrr"]) == pytest.approx(0.85)
    assert float(tumor_row["rest_mean_ccrr"]) == pytest.approx(1.10)
    assert float(tumor_row["mean_ccrr_delta_vs_rest"]) == pytest.approx(-0.25)
    ...
    assert float(tumor_row["ccrr_lt1_frac_delta_vs_rest"]) == pytest.approx(0.50)
...
def test_subgroup_analysis_reports_primary_and_supporting_scopes() -> None:
    subgroup_df, _context_df = ar._build_ccrr_subgroup_analysis(_binary_camelyon_like_per_sample_df())
    ...
    stratum_top = fragile_rows[fragile_rows["scope"] == "stratum"].sort_values(
        ["tail_prevalence", "mean_ccrr"], ascending=[False, True]
    )
...
def test_ccrr_lt1_frac_and_tail_prevalence_stay_distinct() -> None:
    subgroup_df, _context_df = ar._build_ccrr_subgroup_analysis(_binary_camelyon_like_per_sample_df())
...
def test_subgroup_rows_include_tier_metrics_and_statuses() -> None:
    ...
    assert float(fragile_tumor["rest_median_ccrr"]) == pytest.approx(1.25)
    assert float(fragile_tumor["median_ccrr_delta_vs_rest"]) == pytest.approx(-0.55)
    ...
    borderline_tumor = ar._build_ccrr_subgroup_analysis(_borderline_fragility_per_sample_df())[0]
    borderline_tumor_row = borderline_tumor[
        (borderline_tumor["scope"] == "label")
        & (borderline_tumor["label"] == "tumor")
    ].iloc[0]
    assert float(borderline_tumor_row["median_ccrr"]) == pytest.approx(1.15)
    assert float(borderline_tumor_row["rest_median_ccrr"]) == pytest.approx(1.45)
    assert borderline_tumor_row["tier1_status"] == "relative_weakness"

    tier2_df, _ = ar._build_ccrr_subgroup_analysis(_tier2_supported_per_sample_df())
    hidden_row = tier2_df[
    ...
    assert float(hidden_row["ccrr_lt1_frac"]) == pytest.approx(0.3)
    assert int(hidden_row["ccrr_lt1_count"]) == 3
...
def test_markdown_renders_three_tier_tables_per_context() -> None:
    subgroup_df, context_df = ar._build_ccrr_subgroup_analysis(_tier2_supported_per_sample_df())
    ...
    assert "#### Tail-Specific Fragility" in markdown
    assert "| Scope | Subgroup | Status | Median CCRR | Rest Median | Median Delta | CCRR<1 Frac | Rest CCRR<1 Frac | CCRR<1 Delta |" in markdown
    assert "| Scope | Subgroup | Status | N | CCRR<1 Frac | CCRR<1 Count | Median CCRR | Subgroup LTM@alpha | Drop |" in markdown
    assert "| Scope | Subgroup | Status | Tail Prevalence | Overall Tail Prev | Ratio | Tail Mean CCRR | Rest Tail Mean | Severity |" in markdown
...
def test_tail_tier_distinguishes_enriched_and_severe_cases_independently() -> None:
    subgroup_df, context_df = ar._build_ccrr_subgroup_analysis(_sharp_tail_only_per_sample_df())
...
def test_multiclass_dataset_wide_context_is_skipped() -> None:
    per_sample_df = pd.DataFrame(
        [
            _per_sample_row(model="M1", sample_id="a1", label="A", medical_center="X", ccrr_m1=0.8, dataset="tcga"),
            _per_sample_row(model="M1", sample_id="a2", label="A", medical_center="Y", ccrr_m1=1.2, dataset="tcga"),
            _per_sample_row(model="M1", sample_id="b1", label="B", medical_center="X", ccrr_m1=0.9, dataset="tcga"),
            _per_sample_row(model="M1", sample_id="b2", label="B", medical_center="Y", ccrr_m1=1.3, dataset="tcga"),
            _per_sample_row(model="M1", sample_id="c1", label="C", medical_center="X", ccrr_m1=0.95, dataset="tcga"),
            _per_sample_row(model="M1", sample_id="c2", label="C", medical_center="Y", ccrr_m1=1.4, dataset="tcga"),
        ]
    )

    subgroup_df, context_df = ar._build_ccrr_subgroup_analysis(per_sample_df)
...
def test_low_support_groups_remain_in_markdown_with_insufficient_support_status() -> None:
    per_sample_df = pd.DataFrame(
        [
            _per_sample_row(model="M1", sample_id="a1", label="tumor", medical_center="RUMC", ccrr_m1=0.30),
            _per_sample_row(model="M1", sample_id="a2", label="tumor", medical_center="RUMC", ccrr_m1=0.40),
            _per_sample_row(model="M1", sample_id="a3", label="normal", medical_center="UMCU", ccrr_m1=1.10),
            _per_sample_row(model="M1", sample_id="a4", label="normal", medical_center="UMCU", ccrr_m1=1.20),
            _per_sample_row(model="M1", sample_id="a5", label="normal", medical_center="CWZ", ccrr_m1=0.35),
        ]
    )
...
def test_main_writes_model_specific_ccrr_subgroup_outputs(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    subgroup_df = pd.read_csv(out_dir / "model_specific_ccrr_subgroups.csv")
    markdown = (out_dir / "model_specific_ccrr_subgroups.md").read_text(encoding="utf-8")
